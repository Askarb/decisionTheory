...
class ConditionalProfit(models.Model):
    ...
    revenue = models.FloatField(default=0, validators=[MinValueValidator(0),], verbose_name=u'Доход')
    expence = models.FloatField(default=0, validators=[MinValueValidator(0),], verbose_name=u'Издержки' )
    cost = models.FloatField(default=0, validators=[MinValueValidator(0),],  verbose_name=u'Расход')